...
\begin{figure}
	\centering
    \only<1>{\includegraphics[width=\linewidth]{img/epidemiet1.jpg}}
    \only<2>{\includegraphics[width=\linewidth]{img/epidemiet2.jpg}}
    \only<3>{\includegraphics[width=\linewidth]{img/epidemiet3.jpg}}
