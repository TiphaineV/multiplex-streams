...
%
We use two datasets to illustrate our new notions. The first one is a recording of three type of interactions among student in different classes of an high school. The second one is the dataset of the flights of different companies in the US.
%
\subsubsection{Classes in an high school~\cite{cpge}: a social multilayer stream graph}
%
...
\begin{itemize}
	...
	\end{itemize}
\end{itemize}
The \texttt{"Facebook"} and \texttt{"friendship"} doesn't depend on time, they have been recorded from the answers of student at a questionnaire. The links \texttt{"face to face"} have been recorded each 20 seconds during 5 days with receptors on each student. Those receptors detect and record when two student are next to each other.

To have an overwiev on the dataset, we represent all the layers of the relationship \texttt{"face to face"} \cref{visu}, as for \cref{subfig:monkeymls}
\begin{figure}
	\includegraphics[width=0.8\textwidth]{img/lycee/lyceeentier.JPG}
...
\end{figure}
\begin{figure}
	\includegraphics[width=0.8\textwidth]{img/lycee/compfg.pdf}
\end{figure}
\begin{figure}
	\includegraphics[width=0.8\textwidth]{img/lycee/matricegenres.pdf}
\end{figure}
\begin{figure}
	\includegraphics[width=0.8\textwidth]{img/lycee/sousmulticlasseftf.png}
\end{figure}
\begin{figure}
	\includegraphics[width=0.8\textwidth]{img/lycee/tout.png}
\end{figure}
\subsubsection{Civil airlines in US: an application to transportation}
%
\begin{figure}
	\includegraphics[width=0.8\textwidth]{img/planes/map.jpg}
\end{figure}

\begin{figure}
	\includegraphics[width=0.8\textwidth]{img/planes/intricplanes.pdf}
\end{figure}

\begin{figure}
	\includegraphics[width=0.8\textwidth]{img/planes/prVSrw.pdf}
\end{figure}
\subsection{Analysis}
%
